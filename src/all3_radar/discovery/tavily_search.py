...
def build_tavily_review_prompt(
    *,
    ...
    return (
        ...
        "Do not return two URLs for the same underlying event, announcement, policy plan, funding round, deployment, or partnership; choose the strongest source only. "
        ...
        "For housing-policy stories, require a concrete delivery-system angle such as approvals/completions delay, construction-code change, factory/offsite/modular/timber impact, or quantified delivery-capacity evidence; do not select pure campaign, zoning, vacancy, rent, or political process stories. "
        "Prefer primary sources, reputable trade publications, official statistics, and credible business or technology press. "
        "Press-release rehosts such as PR Newswire, Business Wire, GlobeNewswire, StockTitan, and EIN Presswire are acceptable only when no stronger source is present and the story has concrete industrial deployment, production, capacity, or customer evidence. "
