...
- Always format currencies as:
  ...
  USD 25M
  EUR 100M
- For smaller amounts, keep the same style:
  USD 6,800
  GBP 105M
- Never use:
  $25M
  $100B
  EUR100M
- Prefer "USD 25M" over "$25 million".
- End each item with a visible "Link" anchor only.
- Avoid raw URLs in visible text.

Preferred weekly shape:
- interpretive headline
- strongest fact first
- one compact implication
