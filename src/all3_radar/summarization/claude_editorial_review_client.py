...
def build_claude_editorial_review_prompt(
    *,
    ...
    return (
        ...
        "housing industrialization or productivity, quantified UK or German housing-market, rents, prices, supply, "
        "permit, affordability, or residential-investment signals, timber adoption, scaling, economics, or policy, "
        "or large quantified UK public-sector housing or regeneration frameworks that materially shape delivery capacity or pipeline, "
        "or timber building-performance evidence such as quantified heat-loss, thermal-bridge, "
        "or side-by-side material performance comparisons in real building contexts, "
        ...
        "Industrial automation engineering enablement can also be in scope when the story is directly about how robotic, "
        "factory automation, or line-automation systems are designed, programmed, integrated, commissioned, or deployed. "
        "This includes concrete industrial automation engineering tools, manufacturing language models, AI systems for automation cell design, "
        "and AI systems for factory, line, or robotics deployment engineering when the article clearly ties them to physical automation workflows. "
        ...
        "Do not dismiss large UK housing, regeneration, or demolition frameworks as generic contracting vehicle stories when they are quantified public-sector programmes with clear housing-delivery relevance. "
        ...
        "For official statistics stories from sources such as Destatis, keep the headline plain and factual. "
        "Do not append source attribution like 'Destatis reports' to the headline. "
        "Put source attribution in the first sentence of the summary instead. "
        "Avoid repeating the same lead number in both the headline and the first sentence unless repetition is necessary for clarity. "
        ...
        "deployment evidence, or quantified impact, prefer low or medium confidence over a high-confidence rejection. "
        "Use high-confidence promotion only when the article is concrete, credible, and clearly relevant to industrial automation workflows. "
