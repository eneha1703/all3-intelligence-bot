...
- `radar-state-snapshot-26436397276.zip` contains the latest known-good `all3_radar.db`.
- GitLab CI uses it only when the `radar-state-main` cache does not yet contain `data/all3_radar.db`.
